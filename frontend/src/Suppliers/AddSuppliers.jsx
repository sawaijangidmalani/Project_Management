...
//         );
//       } else {
//         res = await axios.post("http://localhost:8000/api/suppliers", customerData);
//       }
...
//           {(editingSuppliers && editingSuppliers._id) ? "Edit Supplier" : "Add Sopplier"}
//         </h3>
//         <label className="customer-form__label">
//           Name:
//           <input
...
//           Status:
//           <Select variant="false" className="form-select mb-3" size="large" placeholder="choose shipping" value={status} onChange={(value) => setStatus(value)}>
//               <Option value="Actvie">Actvie</Option>
//               <Option value="Inactive">Inactive</Option>
//             </Select>
//         </label>
//         <label className="customer-form__label">
