...
// const AddEditPo = ({ edits }) => {
//   const [items, setItems] = useState([]);
//   const [itemId, setItemId] = useState(""); // Changed to itemId for better clarity
//   const [avlqty, setAvlqty] = useState("");
//   const [altqty, setAltqty] = useState("");
//   const [cost, setCost] = useState("");
//   const [tax, setTax] = useState("");
...
//   const handleSubmit = async (e) => {
//     e.preventDefault();
//     console.log('Submitting form with values:', { itemId, avlqty, altqty, remqty, ivnumber, ivdate, cost, tax });
...
//       if (edits && edits._id) {
//         console.log('Updating existing item:', edits._id);
...
//         toast.error(data.error);
//       } else {
//         toast.success(edits ? `${data.itemName} Item details updated` : `${data.itemName} Item details created`);
//       }
//     } catch (err) {
...
//               {item.item} {/* Assuming 'name' is a field in your items data */}
//             </option>
//           ))}
//         </select>
//         <label htmlFor="avlqty" className="availableQty-salesorder_label">
